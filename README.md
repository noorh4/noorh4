...
## 🚀 About Me
- 📊 **Data Scientist** with a strong foundation in analyzing complex data structures, building machine learning models, and delivering data-driven insights.
- 📱 **Full Stack & Mobile Developer** specializing in creating responsive and beautiful cross-platform applications using Flutter and dart.
- 🐍 Passionate about combining software engineering principles with data science to solve real-world problems.

---

## 🛠️ Tech Stack
[![My Skills](https://skillicons.dev/icons?i=python,html,css,flutter,dart,azure)](https://skillicons.dev)
### ✨ Core Technologies
